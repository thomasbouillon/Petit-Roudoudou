...
export const callListPickupPoints = onCall<unknown, Promise<CallListPickUpPointsResponse>>(
...
export const callGetShippingPrices = onCall<unknown, Promise<CallGetShippingPricesResponse>>(
  { cors: '*', secrets: [boxtalPassSecret, boxtalUserSecret] },
  async (event) => {
