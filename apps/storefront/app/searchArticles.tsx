...
// import { Combobox, ComboboxInput, ComboboxOption, ComboboxOptions, Popover } from '@headlessui/react';
...
//         modal={false}
//         as="ul"
//         className="bg-white mt-8 px-4 md:absolute md:mt-2 md:border md:rounded-md md:w-full"
//       >
//         {searchQuery.data?.hits.map((searchResult) => (
//           <ComboboxOption as="li" value={searchResult.id} key={searchResult.id}>
//             <Link
